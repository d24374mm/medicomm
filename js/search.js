        ...
        if(data[i].status == 'Active'){
            ...
            <div class="product-card1">
                <div class="product-image1">
                    ...
                    <img src="../images/${data[i].image1}" class="product-thumb1" alt="">
                    <button class="card-btn1" id="card-btn1">add to wishlist</button>
                </div>
                <div class="product-info1">
                    <a href="../html/product.html/${data[i].id}" class="product-brand1">${data[i].name}</a>
...
if(searchKey == null || searchKey == "../html/search.html"){
