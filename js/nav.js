...
const createNav = () => {
    ...
    <div class="nav-items">
        ...
        <a href="../html/test.html"><img src="../images/cart.png" id="cart-img" alt=""></a>
    </div>
    </div>
    <ul class="links-container">
        <li class="link-item"><a href="../html/index.html" class="link">home</a></li>
        <li class="link-item"><a href="../html/test.html" class="link">buy</a></li>
...
searchBtn.addEventListener('click', () => {
    if(searchBox.value.length){
        location.href = `../html/search/${searchBox.value}`;
    }
})
